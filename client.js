   ...
   if( typeof(ws) == 'undefined' || ws.readyState === undefined || ws.readyState > 1){
     ...
     ws = new WebSocket("ws://localhost:9001/");
	   ...
	   msg = JSON.parse(evt.data)
           ...
           if( msg.event == "refreshPage" ){
			// process message x
			console.log("Can refresh page now... from Java Client - ");
			console.log("User : "+msg.user);
			console.log("Url : "+msg.url);
			}else if( msg.event == "refrestPageFromPython" ){
			// process message x
			console.log("Refresh Request from Python Client...");
			console.log("User : "+msg.user);
			console.log("Url : "+msg.url);
